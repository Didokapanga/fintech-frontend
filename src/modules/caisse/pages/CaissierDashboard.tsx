...
export default function CaissierDashboard() {
  ...
  const { data: caisses = [] } = useCaisses() as {
    data: Caisse[];
  };

  // 🔥 CAISSE ACTIVE (FIX PRINCIPAL)
      ...
      <div className="mb-10 flex flex-col items-center space-y-4">
        ...
        {caisses.length > 1 && (
          <select
            ...
            className="
              px-3 py-1 rounded-lg border bg-white text-sm
          ...
          <>
            <div className="flex items-center gap-3 flex-wrap justify-center">
              ...
              <span className="px-3 py-1 rounded-lg bg-gray-100 text-sm font-medium">
                Caisse {selectedCaisse.code_caisse}
              </span>
            ...
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-800 tracking-tight">
                {Number(selectedCaisse.solde).toLocaleString()}{" "}
